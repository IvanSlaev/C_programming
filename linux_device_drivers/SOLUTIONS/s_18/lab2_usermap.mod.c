...
__attribute__((section("__versions"))) = {
	...
	{ 0x43392095, __VMLINUX_SYMBOL_STR(up_read) },
	{ 0x490a67f6, __VMLINUX_SYMBOL_STR(get_user_pages) },
	{ 0x299e2b83, __VMLINUX_SYMBOL_STR(down_read) },
...
MODULE_INFO(srcversion, "E4DB9EE17C980225D83A581");
